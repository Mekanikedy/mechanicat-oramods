In this branch of the mechanicat-oramods repository are the files for one of my OpenRA modifications, the TD Subfactions mod.

What this mod (TD Subfactions) does  
...
The income bonus also works for Oil Derricks. 
