...
faction-gla-cobra =
    .name = Cobra Cell
    .description = GLA: Cobra Cell
     Faction Variations:
     - Can build the Palace
     - Cobra Tanks are faster but less durable
     Special Ability: Ambush
     Special Unit: Saboteur

faction-gla-scorpion =
    .name = Scorpion Cell
    .description = GLA: Scorpion Cell
     Faction Variations:
     - Can build the Underground Lab
     - Scorpion Tanks are rather balanced
     Special Unit: Chemical Warrior
     Special Unit: Toxin Truck
...
faction-randomgla =
    .name = GLA
    .description = Random GLA Cell
     A random GLA cell is chosen when the game starts
...
actor-scrp-husk-name = Husk (Scorpion Tank)
actor-frog-husk-name = Sukhoi Attack Plane
...
actor-terr =
    .disguisetooltip-name = Fanatic
    .disguisetooltip-generic-name = Soldier
    .description =
    Infantry strapped with explosives.
    Can detect spies.
      Strong vs Infantry
      Weak vs Vehicles and Aircraft
      Special Ability: Disguised
...
actor-jarmen =
    .name = Jarmen Kell
    .description =
    Elite sniper infantry.
    Hides when not moving.
      Strong vs Infantry and Vehicles
      Weak vs Aircraft
...
actor-sb =
    ...
    Can detect submarines.
      Strong vs Naval units, Aircraft
      Weak vs Ground units, Infantry
...
actor-bpwr =
    .name = Power Shed
    .description =
    Provides half the power of a standard
    Power Plant.

actor-mrkt =
    .name = Black Market
    .description =
    Generates income periodically.
    Requires power to operate.

actor-powr-socket-name = unupgraded Power Shed

actor-powrup =
    .name = Wind Turbine
    .description =
    Provides extra power generation.
    Needs to be placed on Power Shed.

actor-bioe =
    .name = Underground Lab
    .description =
    Provides advanced GLA technology.
    Requires power to operate.
    Maximum of one can be built.
      Special Ability: Atom Bomb
...
actor-hsam =
    .name = Camo SAM Site
    .description =
    Camouflaged Anti-Air base defense.
    Requires power to operate.
      Strong vs Aircraft
      Weak vs Ground units
...
actor-sgen =
    ...
    .grantexternalconditionpower-phasedevice-name = Invisibility
    .grantexternalconditionpower-phasedevice-description = Grants invisibility to a group of units
    for 20 seconds.

actor-2fld-description =
    Produces and reloads aircraft.

actor-2yrd-description =
    Produces and repairs ships and
    transports.
...
actor-mobilecamp-name = Mobile Barracks

actor-scrp =
    .name = Scorpion Tank
    .generic-name = Tank
    .description =
    GLA Main Battle Tank.
      Strong vs Light armor
      Weak vs Infantry, Tanks and Aircraft

actor-tcal =
    .name = Technical
    .name-e1 = MG Technical
    .name-e3 = Rocket Technical
    .name-terr = Demo Technical
    .name-e5 = Chem Technical
    .name-sab = Siege Technical
    .name-jarmen = Elite Technical
    .description =
    Convertible pickup truck.
    Can carry just one infantry unit.
    Weapon depends on passenger.
    On default:
      Strong vs Infantry
      Weak vs Vehicles and Aircraft
...
actor-atrk =
    ...
    .description =
    Half-tracked truck, armed with an anti-air cannon.
...
actor-ttrk =
    .name = Toxin Truck
    .description =
    Truck loaded with toxic materials.
    Changes the allegiance of
    enemy vehicles temporarily.
    Has got very weak armor.

actor-0tnk =
    .name = Scout Tank
    .generic-name = Tank
    .description =
    Very fast tank; good for scouting.
    Can carry just one infantry unit.
      Strong vs Light armor
      Weak vs Infantry, Tanks and Aircraft
...
actor-cbra =
    ...
    .generic-name = Tank
    .description =
    GLA Main Battle Tank, with fast speed.
      Strong vs Light armor
      Weak vs Infantry, Tanks and Aircraft
