...
faction-gdia =
    .name = Assault
    .description = GDI Assault branch
     +10% Firepower
     -20% cost of Vehicles
     +10% cost of Aircraft
     Veteran Medium Tanks, Jeeps

faction-gdib =
    .name = Support
    .description = GDI Support branch
     +10% Rate of Fire
     -20% cost of Aircraft
     +10% cost of Vehicles
     Veteran Orcas, APCs
...
faction-gdic =
    .name = Defense
    .description = GDI Defense branch
     +10% Armor
     -20% cost of Defenses
     +10% cost of Infantry
     Veteran Rocket Launchers, Rocket Soldiers

faction-gdid =
    .name = Raider
    .description = GDI Raider branch
     +10% Speed
     -20% cost of Infantry
     +10% cost of Defenses
     Veteran Minigunners, Grenadiers

faction-gdie =
    .name = Heavy
    .description = GDI Heavy branch
     +10% Income
     -25% cost of Adv. Comm. Center
     +10% cost of Refinery, Harvester
     Veteran Mammoth Tanks, Commando
...
faction-noda =
    .name = Assault
    .description = Nod Assault branch
     +10% Firepower
     -20% cost of Vehicles
     +10% cost of Aircraft
     Veteran Nod Buggy, Recon Bikes

faction-nodb =
    .name = Support
    .description = Nod Support branch
     +10% Rate of Fire
     -20% cost of Aircraft
     +10% cost of Vehicles
     Veteran Artillery, Apaches

faction-nodc =
    .name = Defense
    .description = Nod Defense branch
     +10% Armor
     -20% cost of Defenses
     +10% cost of Infantry
     Veteran Light Tanks, Mobile SAM

faction-nodd =
    .name = Raider
    .description = Nod Raider branch
     +10% Speed
     -20% cost of Infantry
     +10% cost of Defenses
     Veteran Flamethrowers, Flame Tanks

faction-node =
    .name = Heavy
    .description = Nod Heavy branch
     +10% Income
     -25% cost for Temple of Nod
     +10% cost of Refinery, Harvester
     Veteran Stealth Tanks, Chemical Warriors
