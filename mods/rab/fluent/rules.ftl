...
checkbox-volkov-enable =
    .label = Enable Volkov
    .description = Allows Soviets to build Volkov as commando
...
faction-spain =
    .name = Spain
    .description = Spain: Anti-Tank
     Special Unit: Advanced Minelayer
     Special Unit: Tank Destroyer

faction-korea =
    .name = Korea
    .description = Korea: Weapons Technology
     Special Unit: Advanced Longbow
     Special Unit: Howitzer
...
faction-kazakh =
    ...
    .description = Kazakhs: Air Power
     ...
     Special Unit: Hind Gunship

faction-china =
    .name = Chinese
    .description = Chinese: Infantry
     Special Ability: Extra Paratroopers
     Special Unit: Heavy Transport
...
actor-nebr-name = Nuclear Bomber

actor-heli-korea =
    .name = Advanced Longbow
    .description =
    Helicopter gunship with multi-purpose missiles.
    Can detect cloaked units and submarines.
      Strong vs Buildings, Vehicles and Aircraft
      Weak vs Infantry
...
actor-nebr-husk-name = Husk (Nuclear Bomber)
actor-heli-korea-husk-name = Advanced Longbow
...
actor-afld =
    ...
    at the selected location.
    .airstrikepower-paranuke-name = Paranuke
    .airstrikepower-paranuke-description = A plane drops parachuted atomic bomb
    at the selected location.
...
actor-mnly-spain-name = Advanced Minelayer
...
actor-btr =
    ...
    .description =
    Heavy armored infantry transport. Armed with chain gun.
      Strong vs Infantry and Light armor
      Weak vs Tanks and Aircraft
