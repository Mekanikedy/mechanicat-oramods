...
actor-xinf =
    .name = Laser Gunner
    .description =
    Elite infantry with portable laser gun.
...
actor-hpad =
    ...
    .encyclopedia =
    Produces and reloads helicopters. Requires a Communications Center to build advanced attack helicopters.
...
actor-fix =
    ...
    .encyclopedia =
    Repairs vehicles for credits. The repair command can be used on units to send them to the nearest repair facility.

actor-eye =
    .name = Advanced Communications Center
    .description =
    Provides radar and Orbital Ion Cannon support power.
    Provides advanced GDI technology.
    Requires power to operate.
    Maximum of one can be built.
...
actor-tmpl =
    ...
    Provides advanced Nod technology.
    Requires power to operate.
    Maximum of one can be built.
    ...
    .encyclopedia =
    Unlocks advanced units and the Nuke support power. If the Communications Center is lost, it restores minimap functionality and unit production.
...
actor-gate =
    .name = Barrier Gate
    .description =
    Automated gate that opens for allied units.
    Can be rotated using the V hotkey. (default)
...
actor-techcenter-name = Temple of Nod or Adv. Comm. Center
...
actor-mrj =
    .name = Mobile Jammer
    .description =
    Jams nearby enemy Radars
    and blocks Stealth detection.
      Unarmed
...
actor-xtnk =
    .name = Laser Tank
    .description =
    Tank with mounted laser cannon.
      Strong vs all Ground units
      Weak vs Aircraft
...
actor-upgrade-conyard =
    ...
    Required to unlock a specific vehicle:
    - MCV
...
actor-upgrade-barracks =
    ...
    Required to unlock a faction-specific vehicle:
    - GDI: APC

actor-upgrade-airstrip =
    .name = Airstrip Upgrade
    .description =
    Unlocks additional units:
    - Recon Bike
    - Light Tank
    - Artillery

actor-upgrade-factory =
    .name = Weapons Factory Upgrade
    .description =
    Unlocks additional units:
    - Medium Tank
    - Rocket Launcher
...
actor-upgrade-radar =
    .name = Communications Upgrade
    .description =
    Unlocks the Air Strike support power.

    Unlocks additional construction options:
    - GDI: Advanced Communications Center
    - Nod: Temple of Nod

    Required to unlock faction-specific units:
    - Nod: Flame Tank, Mobile SAM

actor-upgrade-hitech =
    .name = High Tech Upgrade
    .description =
    Required to unlock faction-specific units:
    - GDI: Commando, Medic, Mammoth Tank
    - Nod: Megan, Chemical Warrior, Stealth Tank
